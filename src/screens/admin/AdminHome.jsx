...
export default function AdminHome({ adminInfo, onLogout }) {
  ...
  const Sidebar = () => (
    <View style={isMobile ? s.sidebarMobile : s.sidebar}>
      <GradientHeader style={[s.sidebarHeader, isMobile && { paddingTop: insets.top + 16, paddingBottom: 16 }]}>
  ...
  return (
    <View style={isMobile ? s.containerMobile : s.container}>
      {isMobile ? (
        <>
          <GradientHeader style={[s.topBar, { paddingTop: insets.top + 12, paddingBottom: 12 }]}>
