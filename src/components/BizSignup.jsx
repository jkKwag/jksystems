...
const local = StyleSheet.create({
  ...
  emailCodeBtn: { flexShrink: 0, width: 80, backgroundColor: "#f97316", borderRadius: 8, paddingVertical: 12, alignItems: "center", justifyContent: "center" },
  emailCodeBtnDisabled: { backgroundColor: "#cbd5e1" },
  emailCodeBtnText: { fontSize: 13, fontWeight: "700", color: "#fff" },
  resendBtn: { flexShrink: 0, width: 80, backgroundColor: "#0f172a", borderRadius: 8, paddingVertical: 12, alignItems: "center", justifyContent: "center" },
