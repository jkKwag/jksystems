...
const s = StyleSheet.create({
  ...
  header: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", padding: 16, borderBottomWidth: 1, borderBottomColor: "#f0f0f0", backgroundColor: "#2563eb", borderTopLeftRadius: 20, borderTopRightRadius: 20 },
  ...
  joinBtn: { backgroundColor: "#2563eb", borderRadius: 12, padding: 15, alignItems: "center", marginTop: 4 },
  joinBtnOff: { backgroundColor: "#94a3b8" },
  joinBtnText: { color: "#fff", fontSize: 15, fontWeight: "800" },

  roomBadge: { backgroundColor: "#eff6ff", paddingHorizontal: 16, paddingVertical: 8, borderBottomWidth: 1, borderBottomColor: "#dbeafe" },
  roomBadgeText: { fontSize: 12, fontWeight: "700", color: "#1d4ed8" },
  ...
  bubbleMe: { backgroundColor: "#2563eb", borderBottomLeftRadius: 16, borderBottomRightRadius: 4 },
  ...
  sendBtn: { backgroundColor: "#2563eb", borderRadius: 22, paddingHorizontal: 16, paddingVertical: 10 },
