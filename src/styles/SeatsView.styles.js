...
export const s = StyleSheet.create({
  ...
  historyRejectRsn: { fontSize: font.sm, color: "#ef4444", fontWeight: "600" },
  ...
  historyCancelBtn: { borderWidth: 1, borderColor: "#ef4444", borderRadius: radius.md, paddingVertical: spacing["2"], alignItems: "center", marginTop: spacing["1"] },
  historyCancelBtnText: { fontSize: font.base, fontWeight: "800", color: "#ef4444" },
