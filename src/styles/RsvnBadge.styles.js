...
export const s = StyleSheet.create({
  badge: { flexDirection: "row", alignItems: "center", backgroundColor: colors.primary, borderRadius: radius.md, paddingHorizontal: spacing["2.5"], paddingVertical: spacing["1.5"], marginBottom: spacing["1.5"], gap: spacing["1.5"], alignSelf: "flex-start" },
