...
export const s = StyleSheet.create({
  ...
  orderStatusBar: { backgroundColor: colors.accentLight, borderRadius: radius.lg, marginHorizontal: spacing["3"], marginTop: spacing["2"], marginBottom: spacing["2"], paddingHorizontal: spacing["4"], paddingVertical: spacing["2.5"] },
