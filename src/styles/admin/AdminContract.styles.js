...
export const s = StyleSheet.create({
  ...
  signBox: { flex: 1, borderWidth: 1, borderColor: colors.blue, backgroundColor: colors.bluePaleBg, borderRadius: radius.lg, paddingVertical: spacing["3"], paddingLeft: spacing["3"], paddingRight: 2, outlineStyle: "none" },
