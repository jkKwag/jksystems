...
export const s = StyleSheet.create({
  ...
  signLineRow: { flexDirection: "row", alignItems: "center", gap: spacing["3"] },
  noWrap: { whiteSpace: "nowrap", flexShrink: 0 },
  signStampSlot: { position: "relative", width: 70, height: 36, alignItems: "center", justifyContent: "center", flexShrink: 0, paddingHorizontal: 10 },
