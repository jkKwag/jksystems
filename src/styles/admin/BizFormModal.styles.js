...
export const s = StyleSheet.create({
  ...
  readonlyText: { fontSize: font.md, fontWeight: "700", color: colors.textMuted, backgroundColor: colors.slate50, borderWidth: 1, borderColor: colors.borderLight, borderRadius: radius.md, paddingHorizontal: spacing["3"], paddingVertical: spacing["2.5"] },
  ...
  noIndText: { fontSize: font.sm, color: colors.textMuted },
