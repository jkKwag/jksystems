...
export const s = StyleSheet.create({
  ...
  pwInput: { borderWidth: 1, borderColor: colors.border, borderRadius: radius.md, padding: spacing["3"], paddingRight: spacing["8"], fontSize: font.md, color: colors.text },
  pwInputValid: { borderColor: colors.green },
  pwInputInvalid: { borderColor: colors.red },
  pwValidIcon: { position: "absolute", right: spacing["3"], fontSize: font.lg, fontWeight: "900" },
