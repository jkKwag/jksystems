...
export const s = StyleSheet.create({
  badge: { flexDirection: "row", alignItems: "center", justifyContent: "center", backgroundColor: colors.primary, borderRadius: radius.md, paddingHorizontal: spacing["2.5"], paddingVertical: spacing["1.5"], marginTop: spacing["2"], marginBottom: spacing["1.5"], gap: spacing["1.5"] },
