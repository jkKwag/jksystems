      ...
      },
      {
        ...
        parameters: {
          ...
          properties: {
            ...
            req_cont: { type: "STRING", description: "손님 요청사항 (선택)" },
          },
...
- 추천할 때는 반드시 recommend_item 함수를 호출해. 함수를 호출하면 사진이 자동 표시되니 음식 외관 설명은 생략해도 되지만, 텍스트에는 메뉴 이름을 꼭 언급해. 예: "스캔잇 직화 삼겹살을 추천드려요!"
